        # Adaptsim: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/adaptsim.git

        ## Objective

        AdaptSim is a browser-based adaptive clinical trial simulator validated against rpact, supporting group-sequential, response-adaptive, and platform trial designs.
        ...
        - Code: https://github.com/mahmood726-cyber/adaptsim.git
        - Dashboard: https://mahmood726-cyber.github.io/adaptsim/
